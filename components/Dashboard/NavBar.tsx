...
const NavBar = () => {
    ...
    return (
        <>
            ...
            {((storedUser?.usageOverview?.totalTokens || 0) - (storedUser?.usageOverview?.tokensUsed || 0)) < 500 && <div className="sticky top-0 z-40 flex items-center justify-center text-[0.9rem] gap-4 px-6 py-4 h-11 bg-[#483C16] text-[#FFC106] tracking-wide">
                Please add tokens in your account in to continue generating README files with GitDocs AI.
            </div>}
        </>
    )
}
