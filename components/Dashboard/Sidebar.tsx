...
export default function Sidebar() {
  ...
  const menuItems = [
    { icon: LayoutDashboard, label: "Dashboard", href: "/", isActive: pathname === "/" },
    { icon: BookOpen, label: "Documentation", href: "#", isActive: pathname === "/documentation" },
    { icon: Settings, label: "Settings", href: "#", isActive: pathname === "/settings" },
    { icon: HelpCircle, label: "Help & Support", href: "#", isActive: pathname === "/help" },
  ];
                ...
                <Tooltip key={index}>
                  <TooltipTrigger asChild>
                    <li>
                      <a
                        href={item.href}
                        className={cn("w-full flex p-2 mb-3 rounded-lg group", item.isActive ? "bg-white text-black" : "hover:bg-[#232A34] text-[#cfcfd1]")}
                      >
                        <item.icon className={cn("h-6 w-6", item.isActive ? "text-black" : "text-[#E8E8E9]")} />
                      </a>
                    </li>
                  </TooltipTrigger>
                  <TooltipContent
