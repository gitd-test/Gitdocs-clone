        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-24 mb-12">
          <div>
            ...
            <div className="flex space-x-4">
              ...
              <a href="https://x.com/GitdocsAI" target="_blank" rel="noopener noreferrer" className="text-muted-foreground hover:text-gitdocs-blue">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/#about" className="text-muted-foreground hover:text-gitdocs-blue">About Us</Link></li>
              <li><Link href="/blog" className="text-muted-foreground hover:text-gitdocs-blue">Blog</Link></li>
              <li><Link href="/contact" className="text-muted-foreground hover:text-gitdocs-blue">Contact Us</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link href="/terms" className="text-muted-foreground hover:text-gitdocs-blue">Terms & Conditions</Link></li>
              <li><Link href="/privacy" className="text-muted-foreground hover:text-gitdocs-blue">Privacy Policy</Link></li>
              <li><Link href="/cancellation-refund" className="text-muted-foreground hover:text-gitdocs-blue">Cancellation & Refund</Link></li>
              <li><Link href="/shipping-delivery" className="text-muted-foreground hover:text-gitdocs-blue">Shipping & Delivery</Link></li>
            </ul>
          </div>
        </div>
